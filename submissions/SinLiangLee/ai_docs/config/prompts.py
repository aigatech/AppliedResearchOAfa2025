...
Provide only the commit message, nothing else.""",
    ...
    def load_template_from_file(self, name: str, file_path: Path, description: str = ""):
...
def render_analysis_prompt(diff_content: str, template_name: str = "change_analysis") -> str:
